...
#define vec_ge(x,y) 		vec_eq(_mm_max_epu8(x, y), x)
#define vec_lt(x,y) 		_mm_xor_si128(vec_ge(x,y), _mm_set1_epi8((char)0xff))
#define vec_gt(x,y) 		vec_lt(y,x) 
...
void SigmaDelta_step0_SSE2_omp(vuint8 **I, vuint8 **M, vuint8 **V, int vi0, int vi1, int vj0, int vj1);
void SigmaDelta_1step_SSE2_omp(vuint8 **I, vuint8 **M0, vuint8 **V0, vuint8 **E, int vi0, int vi1, int vj0, int vj1);
#endif
